...
I write code; here you will find some, but not all of it. My interests lie in automation, architecting solutions, machine learning, and most recently game development although the latter is much more of a hobby than something I am seeking to do professionally

## <img src="./assets/loader.gif" alt="Banner GIF" width="4%"> About Me <img src="./assets/loader.gif" alt="Banner GIF" width="4%">

- Current professional specialization lies in Application Engineering
- Always learning and expanding my skill set, and displaying many of the projects I use to do so here
- Currently GameDev Maxxing in my spare time, and a few other random side projects here and there
